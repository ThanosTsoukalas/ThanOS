...
function dragElement(elmnt) {
  ...
  function windowHeaderCleanup(elements, words) {
    return elements.filter(element => {
      const idWords = element.id.split('-');
      return !words.some(word => idWords.includes(word));
    });
  }
...
const draggableElementsWithoutHeaders = windowHeaderCleanup(draggableElements, 'header');
